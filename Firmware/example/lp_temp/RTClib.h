...
#define DS3231_TEMPLOWER  0x12
#define DS3231_TEMPUPPER  0x11
...
public:
    ...
    uint8_t temperature(bool start); /*passing a bool makes the module start the temperture conversion. False obtains the temp*/
};
